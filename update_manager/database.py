...
class Database:
    ...
    def __init__(self, db_dir: str) -> None:
        ...
        self.ur_dir = Path(getenv('UR_DIR', Path(db_dir).expanduser()))
        self.ensure_ur_dir()
        self.__db_file = self.ur_dir / DB_FILE
        self.__db_dict = {}
    ...
    def read_and_validate_db_file(self) -> None:
        ...
        with Path(self.__db_file).open(encoding='utf_8') as dbf:
    ...
    def entry_present(self, repo_path: Path) -> bool:
        ...
        if repo_path in self.db_dict:
            return self.db_dict[repo_path]
        return None
    ...
    def write_out_db_file(self) -> None:
        ...
        with Path(self.__db_file).open(mode='w', encoding='utf_8') as dbf:
            dbf.write(DB_HEADER)
